...
作者：magic282\n
时间：2019/06/05\n
用法：python find_oracle_para.py filename1 filename2 filename3
'''
import sys
import itertools
import gc
...
from cnndm_acl18_master.PyRouge.Rouge.Rouge import Rouge
from cnndm_acl18_master.Document import Document
